...
public class CipherSuiteInfo {
    ...
    static CipherSuiteInfo forCipherSuite(int cipherSuite, String name) {
        ...
        return new CipherSuiteInfo(cipherSuite, name, isTLSv13, java.util.Collections.unmodifiableSet(decompositionTLS), java.util.Collections.unmodifiableSet(decompositionX509));
    }
