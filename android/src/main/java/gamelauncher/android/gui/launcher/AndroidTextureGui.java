 ...
 * @author DasBabyPixel
 */
public class AndroidTextureGui extends ParentableAbstractGui implements TextureGui {
    ...
    public AndroidTextureGui(GameLauncher launcher, GLES gles) throws GameException {
        super(launcher);
