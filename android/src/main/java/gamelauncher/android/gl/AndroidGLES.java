...
public class AndroidGLES implements gamelauncher.gles.gl.GLES32 {

    private static final AndroidGLES instance = new AndroidGLES();

    private AndroidGLES() {
    }

    public static AndroidGLES instance() {
        return instance;
    }
    ...
    public void glBufferData(int target, long size, Buffer data, int usage) {
        GLES32.glBufferData(target, (int) size, data, usage);
    }

    @Override
    public void glBufferSubData(int target, int offset, long size, Buffer data) {
        GLES32.glBufferSubData(target, offset, (int) size, data);
    }
    ...
    public void glCompressedTexImage2D(int target, int level, int internalformat, int width, int height, int border, int imageSize, Buffer data) {
        GLES32.glCompressedTexImage2D(target, level, internalformat, width, height, border, imageSize, data);
    }

    @Override
    public void glCompressedTexSubImage2D(int target, int level, int xoffset, int yoffset, int width, int height, int format, int imageSize, Buffer data) {
        GLES32.glCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, imageSize, data);
    }
    ...
    public void glDeleteBuffers(int n, int[] buffers, int offset) {
        GLES32.glDeleteBuffers(n, buffers, offset);
    }

    @Override
    public void glDeleteBuffers(int n, IntBuffer buffers) {
        GLES32.glDeleteBuffers(n, buffers);
    }

    @Override
    public void glDeleteFramebuffers(int n, int[] framebuffers, int offset) {
        GLES32.glDeleteFramebuffers(n, framebuffers, offset);
    }

    @Override
    public void glDeleteFramebuffers(int n, IntBuffer framebuffers) {
        GLES32.glDeleteFramebuffers(n, framebuffers);
    }
    ...
    public void glDeleteRenderbuffers(int n, int[] renderbuffers, int offset) {
        GLES32.glDeleteRenderbuffers(n, renderbuffers, offset);
    }

    @Override
    public void glDeleteRenderbuffers(int n, IntBuffer renderbuffers) {
        GLES32.glDeleteRenderbuffers(n, renderbuffers);
    }
    ...
    public void glDeleteTextures(int n, int[] textures, int offset) {
        GLES32.glDeleteTextures(n, textures, offset);
    }

    @Override
    public void glDeleteTextures(int n, IntBuffer textures) {
        GLES32.glDeleteTextures(n, textures);
    }
    ...
    public void glGenBuffers(int n, int[] buffers, int offset) {
        GLES32.glGenBuffers(n, buffers, offset);
    }

    @Override
    public void glGenBuffers(int n, IntBuffer buffers) {
        GLES32.glGenBuffers(n, buffers);
    }
    ...
    public void glGenFramebuffers(int n, int[] framebuffers, int offset) {
        GLES32.glGenFramebuffers(n, framebuffers, offset);
    }

    @Override
    public void glGenFramebuffers(int n, IntBuffer framebuffers) {
        GLES32.glGenFramebuffers(n, framebuffers);
    }

    @Override
    public void glGenRenderbuffers(int n, int[] renderbuffers, int offset) {
        GLES32.glGenRenderbuffers(n, renderbuffers, offset);
    }

    @Override
    public void glGenRenderbuffers(int n, IntBuffer renderbuffers) {
        GLES32.glGenRenderbuffers(n, renderbuffers);
    }

    @Override
    public void glGenTextures(int n, int[] textures, int offset) {
        GLES32.glGenTextures(n, textures, offset);
    }

    @Override
    public void glGenTextures(int n, IntBuffer textures) {
        GLES32.glGenTextures(n, textures);
    }
    ...
    public void glGetActiveAttrib(int program, int index, int bufsize, int[] length, int lengthOffset, int[] size, int sizeOffset, int[] type, int typeOffset, byte[] name, int nameOffset) {
        GLES32.glGetActiveAttrib(program, index, bufsize, length, lengthOffset, size, sizeOffset, type, typeOffset, name, nameOffset);
    }

    @Override
    public String glGetActiveAttrib(int program, int index, int[] size, int sizeOffset, int[] type, int typeOffset) {
        return GLES32.glGetActiveAttrib(program, index, size, sizeOffset, type, typeOffset);
    }
    ...
    public void glGetActiveUniform(int program, int index, int bufsize, int[] length, int lengthOffset, int[] size, int sizeOffset, int[] type, int typeOffset, byte[] name, int nameOffset) {
        GLES32.glGetActiveUniform(program, index, bufsize, length, lengthOffset, size, sizeOffset, type, typeOffset, name, nameOffset);
    }

    @Override
    public String glGetActiveUniform(int program, int index, int[] size, int sizeOffset, int[] type, int typeOffset) {
        return GLES32.glGetActiveUniform(program, index, size, sizeOffset, type, typeOffset);
    }
    ...
    public void glGetAttachedShaders(int program, int maxcount, int[] count, int countOffset, int[] shaders, int shadersOffset) {
        GLES32.glGetAttachedShaders(program, maxcount, count, countOffset, shaders, shadersOffset);
    }

    @Override
    public void glGetAttachedShaders(int program, int maxcount, IntBuffer count, IntBuffer shaders) {
        GLES32.glGetAttachedShaders(program, maxcount, count, shaders);
    }
    ...
    public void glGetBooleanv(int pname, boolean[] params, int offset) {
        GLES32.glGetBooleanv(pname, params, offset);
    }

    @Override
    public void glGetBooleanv(int pname, IntBuffer params) {
        GLES32.glGetBooleanv(pname, params);
    }

    @Override
    public void glGetBufferParameteriv(int target, int pname, int[] params, int offset) {
        GLES32.glGetBufferParameteriv(target, pname, params, offset);
    }
    ...
    public void glGetFloatv(int pname, float[] params, int offset) {
        GLES32.glGetFloatv(pname, params, offset);
    }
    ...
    public void glGetFramebufferAttachmentParameteriv(int target, int attachment, int pname, int[] params, int offset) {
        GLES32.glGetFramebufferAttachmentParameteriv(target, attachment, pname, params, offset);
    }
    ...
    public void glGetIntegerv(int pname, int[] params, int offset) {
        GLES32.glGetIntegerv(pname, params, offset);
    }
    ...
    public void glGetProgramiv(int program, int pname, int[] params, int offset) {
        GLES32.glGetProgramiv(program, pname, params, offset);
    }
    ...
    public void glGetRenderbufferParameteriv(int target, int pname, int[] params, int offset) {
        GLES32.glGetRenderbufferParameteriv(target, pname, params, offset);
    }
    ...
    public void glGetShaderiv(int shader, int pname, int[] params, int offset) {
        GLES32.glGetShaderiv(shader, pname, params, offset);
    }
    ...
    public void glGetShaderPrecisionFormat(int shadertype, int precisiontype, int[] range, int rangeOffset, int[] precision, int precisionOffset) {
        GLES32.glGetShaderPrecisionFormat(shadertype, precisiontype, range, rangeOffset, precision, precisionOffset);
    }
    ...
    public void glGetShaderSource(int shader, int bufsize, int[] length, int lengthOffset, byte[] source, int sourceOffset) {
        GLES32.glGetShaderSource(shader, bufsize, length, lengthOffset, source, sourceOffset);
    }
    ...
    public void glGetTexParameterfv(int target, int pname, float[] params, int offset) {
        GLES32.glGetTexParameterfv(target, pname, params, offset);
    }
    ...
    public void glGetTexParameteriv(int target, int pname, int[] params, int offset) {
        GLES32.glGetTexParameteriv(target, pname, params, offset);
    }
    ...
    public void glGetUniformfv(int program, int location, float[] params, int offset) {
        GLES32.glGetUniformfv(program, location, params, offset);
    }
    ...
    public void glGetUniformiv(int program, int location, int[] params, int offset) {
        GLES32.glGetUniformiv(program, location, params, offset);
    }
    ...
    public void glGetVertexAttribfv(int index, int pname, float[] params, int offset) {
        GLES32.glGetVertexAttribfv(index, pname, params, offset);
    }
    ...
    public void glGetVertexAttribiv(int index, int pname, int[] params, int offset) {
        GLES32.glGetVertexAttribiv(index, pname, params, offset);
    }
    ...
    public void glReadPixels(int x, int y, int width, int height, int format, int type, Buffer pixels) {
        GLES32.glReadPixels(x, y, width, height, format, type, pixels);
    }
    ...
    public void glShaderBinary(int n, int[] shaders, int offset, int binaryformat, Buffer binary, int length) {
        GLES32.glShaderBinary(n, shaders, offset, binaryformat, binary, length);
    }

    @Override
    public void glShaderBinary(int n, IntBuffer shaders, int binaryformat, Buffer binary, int length) {
        GLES32.glShaderBinary(n, shaders, binaryformat, binary, length);
    }
    ...
    public void glTexParameterfv(int target, int pname, float[] params, int offset) {
        GLES32.glTexParameterfv(target, pname, params, offset);
    }
    ...
    public void glTexParameteriv(int target, int pname, int[] params, int offset) {
        GLES32.glTexParameteriv(target, pname, params, offset);
    }
    ...
    public void glUniform1fv(int location, int count, float[] v, int offset) {
        GLES32.glUniform1fv(location, count, v, offset);
    }

    @Override
    public void glUniform1fv(int location, int count, FloatBuffer v) {
        GLES32.glUniform1fv(location, count, v);
    }
    ...
    public void glUniform1iv(int location, int count, int[] v, int offset) {
        GLES32.glUniform1iv(location, count, v, offset);
    }

    @Override
    public void glUniform1iv(int location, int count, IntBuffer v) {
        GLES32.glUniform1iv(location, count, v);
    }
    ...
    public void glUniform2fv(int location, int count, float[] v, int offset) {
        GLES32.glUniform2fv(location, count, v, offset);
    }

    @Override
    public void glUniform2fv(int location, int count, FloatBuffer v) {
        GLES32.glUniform2fv(location, count, v);
    }
    ...
    public void glUniform2iv(int location, int count, int[] v, int offset) {
        GLES32.glUniform2iv(location, count, v, offset);
    }

    @Override
    public void glUniform2iv(int location, int count, IntBuffer v) {
        GLES32.glUniform2iv(location, count, v);
    }
    ...
    public void glUniform3fv(int location, int count, float[] v, int offset) {
        GLES32.glUniform3fv(location, count, v, offset);
    }

    @Override
    public void glUniform3fv(int location, int count, FloatBuffer v) {
        GLES32.glUniform3fv(location, count, v);
    }
    ...
    public void glUniform3iv(int location, int count, int[] v, int offset) {
        GLES32.glUniform3iv(location, count, v, offset);
    }

    @Override
    public void glUniform3iv(int location, int count, IntBuffer v) {
        GLES32.glUniform3iv(location, count, v);
    }
    ...
    public void glUniform4fv(int location, int count, float[] v, int offset) {
        GLES32.glUniform4fv(location, count, v, offset);
    }

    @Override
    public void glUniform4fv(int location, int count, FloatBuffer v) {
        GLES32.glUniform4fv(location, count, v);
    }
    ...
    public void glUniform4iv(int location, int count, int[] v, int offset) {
        GLES32.glUniform4iv(location, count, v, offset);
    }

    @Override
    public void glUniform4iv(int location, int count, IntBuffer v) {
        GLES32.glUniform4iv(location, count, v);
    }

    @Override
    public void glUniformMatrix2fv(int location, int count, boolean transpose, float[] value, int offset) {
        GLES32.glUniformMatrix2fv(location, count, transpose, value, offset);
    }

    @Override
    public void glUniformMatrix2fv(int location, int count, boolean transpose, FloatBuffer value) {
        GLES32.glUniformMatrix2fv(location, count, transpose, value);
    }
    ...
    public void glUniformMatrix3fv(int location, int count, boolean transpose, FloatBuffer value) {
        GLES32.glUniformMatrix3fv(location, count, transpose, value);
    }
    ...
    public void glUniformMatrix4fv(int location, int count, boolean transpose, FloatBuffer value) {
        GLES32.glUniformMatrix4fv(location, count, transpose, value);
    }
    ...
    public void glVertexAttrib1fv(int indx, float[] values, int offset) {
        GLES32.glVertexAttrib1fv(indx, values, offset);
    }
    ...
    public void glVertexAttrib2fv(int indx, float[] values, int offset) {
        GLES32.glVertexAttrib2fv(indx, values, offset);
    }
    ...
    public void glVertexAttrib3fv(int indx, float[] values, int offset) {
        GLES32.glVertexAttrib3fv(indx, values, offset);
    }
    ...
    public void glVertexAttrib4fv(int indx, float[] values, int offset) {
        GLES32.glVertexAttrib4fv(indx, values, offset);
    }
    ...
    public void glDrawRangeElements(int mode, int start, int end, int count, int type, Buffer indices) {
        GLES32.glDrawRangeElements(mode, start, end, count, type, indices);
    }
    ...
    public void glCompressedTexImage3D(int target, int level, int internalformat, int width, int height, int depth, int border, int imageSize, Buffer data) {
        GLES32.glCompressedTexImage3D(target, level, internalformat, width, height, depth, border, imageSize, data);
    }
    ...
    public void glCompressedTexSubImage3D(int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int imageSize, Buffer data) {
        GLES32.glCompressedTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, data);
    }
    ...
    public void glGenQueries(int n, int[] ids, int offset) {
        GLES32.glGenQueries(n, ids, offset);
    }

    @Override
    public void glGenQueries(int n, IntBuffer ids) {
        GLES32.glGenQueries(n, ids);
    }

    @Override
    public void glDeleteQueries(int n, int[] ids, int offset) {
        GLES32.glDeleteQueries(n, ids, offset);
    }

    @Override
    public void glDeleteQueries(int n, IntBuffer ids) {
        GLES32.glDeleteQueries(n, ids);
    }
    ...
    public void glGetQueryiv(int target, int pname, int[] params, int offset) {
        GLES32.glGetQueryiv(target, pname, params, offset);
    }
    ...
    public void glGetQueryObjectuiv(int id, int pname, int[] params, int offset) {
        GLES32.glGetQueryObjectuiv(id, pname, params, offset);
    }
    ...
    public Buffer glGetBufferPointerv(int target, int pname) {
        return GLES32.glGetBufferPointerv(target, pname);
    }

    @Override
    public void glDrawBuffers(int n, int[] bufs, int offset) {
        GLES32.glDrawBuffers(n, bufs, offset);
    }

    @Override
    public void glDrawBuffers(int n, IntBuffer bufs) {
        GLES32.glDrawBuffers(n, bufs);
    }

    @Override
    public void glUniformMatrix2x3fv(int location, int count, boolean transpose, float[] value, int offset) {
        GLES32.glUniformMatrix2x3fv(location, count, transpose, value, offset);
    }

    @Override
    public void glUniformMatrix2x3fv(int location, int count, boolean transpose, FloatBuffer value) {
        GLES32.glUniformMatrix2x3fv(location, count, transpose, value);
    }

    @Override
    public void glUniformMatrix3x2fv(int location, int count, boolean transpose, float[] value, int offset) {
        GLES32.glUniformMatrix3x2fv(location, count, transpose, value, offset);
    }

    @Override
    public void glUniformMatrix3x2fv(int location, int count, boolean transpose, FloatBuffer value) {
        GLES32.glUniformMatrix3x2fv(location, count, transpose, value);
    }

    @Override
    public void glUniformMatrix2x4fv(int location, int count, boolean transpose, float[] value, int offset) {
        GLES32.glUniformMatrix2x4fv(location, count, transpose, value, offset);
    }

    @Override
    public void glUniformMatrix2x4fv(int location, int count, boolean transpose, FloatBuffer value) {
        GLES32.glUniformMatrix2x4fv(location, count, transpose, value);
    }

    @Override
    public void glUniformMatrix4x2fv(int location, int count, boolean transpose, float[] value, int offset) {
        GLES32.glUniformMatrix4x2fv(location, count, transpose, value, offset);
    }

    @Override
    public void glUniformMatrix4x2fv(int location, int count, boolean transpose, FloatBuffer value) {
        GLES32.glUniformMatrix4x2fv(location, count, transpose, value);
    }

    @Override
    public void glUniformMatrix3x4fv(int location, int count, boolean transpose, float[] value, int offset) {
        GLES32.glUniformMatrix3x4fv(location, count, transpose, value, offset);
    }

    @Override
    public void glUniformMatrix3x4fv(int location, int count, boolean transpose, FloatBuffer value) {
        GLES32.glUniformMatrix3x4fv(location, count, transpose, value);
    }

    @Override
    public void glUniformMatrix4x3fv(int location, int count, boolean transpose, float[] value, int offset) {
        GLES32.glUniformMatrix4x3fv(location, count, transpose, value, offset);
    }

    @Override
    public void glUniformMatrix4x3fv(int location, int count, boolean transpose, FloatBuffer value) {
        GLES32.glUniformMatrix4x3fv(location, count, transpose, value);
    }
    ...
    public void glDeleteVertexArrays(int n, int[] arrays, int offset) {
        GLES32.glDeleteVertexArrays(n, arrays, offset);
    }

    @Override
    public void glDeleteVertexArrays(int n, IntBuffer arrays) {
        GLES32.glDeleteVertexArrays(n, arrays);
    }

    @Override
    public void glGenVertexArrays(int n, int[] arrays, int offset) {
        GLES32.glGenVertexArrays(n, arrays, offset);
    }

    @Override
    public void glGenVertexArrays(int n, IntBuffer arrays) {
        GLES32.glGenVertexArrays(n, arrays);
    }
    ...
    public void glGetIntegeri_v(int target, int index, int[] data, int offset) {
        GLES32.glGetIntegeri_v(target, index, data, offset);
    }
    ...
    public void glGetTransformFeedbackVarying(int program, int index, int bufsize, int[] length, int lengthOffset, int[] size, int sizeOffset, int[] type, int typeOffset, byte[] name, int nameOffset) {
        GLES32.glGetTransformFeedbackVarying(program, index, bufsize, length, lengthOffset, size, sizeOffset, type, typeOffset, name, nameOffset);
    }
    ...
    public void glGetTransformFeedbackVarying(int program, int index, int bufsize, IntBuffer length, IntBuffer size, IntBuffer type, byte name) {
        GLES32.glGetTransformFeedbackVarying(program, index, bufsize, length, size, type, name);
    }
    ...
    public String glGetTransformFeedbackVarying(int program, int index, int[] size, int sizeOffset, int[] type, int typeOffset) {
        return GLES32.glGetTransformFeedbackVarying(program, index, size, sizeOffset, type, typeOffset);
    }
    ...
    public void glGetVertexAttribIiv(int index, int pname, int[] params, int offset) {
        GLES32.glGetVertexAttribIiv(index, pname, params, offset);
    }
    ...
    public void glGetVertexAttribIuiv(int index, int pname, int[] params, int offset) {
        GLES32.glGetVertexAttribIuiv(index, pname, params, offset);
    }
    ...
    public void glVertexAttribI4iv(int index, int[] v, int offset) {
        GLES32.glVertexAttribI4iv(index, v, offset);
    }
    ...
    public void glVertexAttribI4uiv(int index, int[] v, int offset) {
        GLES32.glVertexAttribI4uiv(index, v, offset);
    }
    ...
    public void glGetUniformuiv(int program, int location, int[] params, int offset) {
        GLES32.glGetUniformuiv(program, location, params, offset);
    }
    ...
    public void glUniform1uiv(int location, int count, int[] value, int offset) {
        GLES32.glUniform1uiv(location, count, value, offset);
    }

    @Override
    public void glUniform1uiv(int location, int count, IntBuffer value) {
        GLES32.glUniform1uiv(location, count, value);
    }

    @Override
    public void glUniform2uiv(int location, int count, int[] value, int offset) {
        GLES32.glUniform2uiv(location, count, value, offset);
    }

    @Override
    public void glUniform2uiv(int location, int count, IntBuffer value) {
        GLES32.glUniform2uiv(location, count, value);
    }

    @Override
    public void glUniform3uiv(int location, int count, int[] value, int offset) {
        GLES32.glUniform3uiv(location, count, value, offset);
    }

    @Override
    public void glUniform3uiv(int location, int count, IntBuffer value) {
        GLES32.glUniform3uiv(location, count, value);
    }

    @Override
    public void glUniform4uiv(int location, int count, int[] value, int offset) {
        GLES32.glUniform4uiv(location, count, value, offset);
    }

    @Override
    public void glUniform4uiv(int location, int count, IntBuffer value) {
        GLES32.glUniform4uiv(location, count, value);
    }

    @Override
    public void glClearBufferiv(int buffer, int drawbuffer, int[] value, int offset) {
        GLES32.glClearBufferiv(buffer, drawbuffer, value, offset);
    }
    ...
    public void glClearBufferuiv(int buffer, int drawbuffer, int[] value, int offset) {
        GLES32.glClearBufferuiv(buffer, drawbuffer, value, offset);
    }
    ...
    public void glClearBufferfv(int buffer, int drawbuffer, float[] value, int offset) {
        GLES32.glClearBufferfv(buffer, drawbuffer, value, offset);
    }
    ...
    public void glGetUniformIndices(int program, String[] uniformNames, int[] uniformIndices, int uniformIndicesOffset) {
        GLES32.glGetUniformIndices(program, uniformNames, uniformIndices, uniformIndicesOffset);
    }
    ...
    public void glGetActiveUniformsiv(int program, int uniformCount, int[] uniformIndices, int uniformIndicesOffset, int pname, int[] params, int paramsOffset) {
        GLES32.glGetActiveUniformsiv(program, uniformCount, uniformIndices, uniformIndicesOffset, pname, params, paramsOffset);
    }

    @Override
    public void glGetActiveUniformsiv(int program, int uniformCount, IntBuffer uniformIndices, int pname, IntBuffer params) {
        GLES32.glGetActiveUniformsiv(program, uniformCount, uniformIndices, pname, params);
    }
    ...
    public void glGetActiveUniformBlockiv(int program, int uniformBlockIndex, int pname, int[] params, int offset) {
        GLES32.glGetActiveUniformBlockiv(program, uniformBlockIndex, pname, params, offset);
    }
    ...
    public void glGetActiveUniformBlockName(int program, int uniformBlockIndex, int bufSize, int[] length, int lengthOffset, byte[] uniformBlockName, int uniformBlockNameOffset) {
        GLES32.glGetActiveUniformBlockName(program, uniformBlockIndex, bufSize, length, lengthOffset, uniformBlockName, uniformBlockNameOffset);
    }

    @Override
    public void glGetActiveUniformBlockName(int program, int uniformBlockIndex, Buffer length, Buffer uniformBlockName) {
        GLES32.glGetActiveUniformBlockName(program, uniformBlockIndex, length, uniformBlockName);
    }
    ...
    public void glDrawElementsInstanced(int mode, int count, int type, Buffer indices, int instanceCount) {
        GLES32.glDrawElementsInstanced(mode, count, type, indices, instanceCount);
    }
    ...
    public void glGetInteger64v(int pname, long[] params, int offset) {
        GLES32.glGetInteger64v(pname, params, offset);
    }
    ...
    public void glGetSynciv(long sync, int pname, int bufSize, int[] length, int lengthOffset, int[] values, int valuesOffset) {
        GLES32.glGetSynciv(sync, pname, bufSize, length, lengthOffset, values, valuesOffset);
    }

    @Override
    public void glGetSynciv(long sync, int pname, int bufSize, IntBuffer length, IntBuffer values) {
        GLES32.glGetSynciv(sync, pname, bufSize, length, values);
    }

    @Override
    public void glGetInteger64i_v(int target, int index, long[] data, int offset) {
        GLES32.glGetInteger64i_v(target, index, data, offset);
    }
    ...
    public void glGetBufferParameteri64v(int target, int pname, long[] params, int offset) {
        GLES32.glGetBufferParameteri64v(target, pname, params, offset);
    }
    ...
    public void glGenSamplers(int count, int[] samplers, int offset) {
        GLES32.glGenSamplers(count, samplers, offset);
    }

    @Override
    public void glGenSamplers(int count, IntBuffer samplers) {
        GLES32.glGenSamplers(count, samplers);
    }

    @Override
    public void glDeleteSamplers(int count, int[] samplers, int offset) {
        GLES32.glDeleteSamplers(count, samplers, offset);
    }

    @Override
    public void glDeleteSamplers(int count, IntBuffer samplers) {
        GLES32.glDeleteSamplers(count, samplers);
    }
    ...
    public void glSamplerParameteriv(int sampler, int pname, int[] param, int offset) {
        GLES32.glSamplerParameteriv(sampler, pname, param, offset);
    }
    ...
    public void glSamplerParameterfv(int sampler, int pname, float[] param, int offset) {
        GLES32.glSamplerParameterfv(sampler, pname, param, offset);
    }
    ...
    public void glGetSamplerParameteriv(int sampler, int pname, int[] params, int offset) {
        GLES32.glGetSamplerParameteriv(sampler, pname, params, offset);
    }
    ...
    public void glGetSamplerParameterfv(int sampler, int pname, float[] params, int offset) {
        GLES32.glGetSamplerParameterfv(sampler, pname, params, offset);
    }
    ...
    public void glDeleteTransformFeedbacks(int n, int[] ids, int offset) {
        GLES32.glDeleteTransformFeedbacks(n, ids, offset);
    }

    @Override
    public void glDeleteTransformFeedbacks(int n, IntBuffer ids) {
        GLES32.glDeleteTransformFeedbacks(n, ids);
    }

    @Override
    public void glGenTransformFeedbacks(int n, int[] ids, int offset) {
        GLES32.glGenTransformFeedbacks(n, ids, offset);
    }

    @Override
    public void glGenTransformFeedbacks(int n, IntBuffer ids) {
        GLES32.glGenTransformFeedbacks(n, ids);
    }
    ...
    public void glGetProgramBinary(int program, int bufSize, int[] length, int lengthOffset, int[] binaryFormat, int binaryFormatOffset, Buffer binary) {
        GLES32.glGetProgramBinary(program, bufSize, length, lengthOffset, binaryFormat, binaryFormatOffset, binary);
    }

    @Override
    public void glGetProgramBinary(int program, int bufSize, IntBuffer length, IntBuffer binaryFormat, Buffer binary) {
        GLES32.glGetProgramBinary(program, bufSize, length, binaryFormat, binary);
    }

    @Override
    public void glProgramBinary(int program, int binaryFormat, Buffer binary, int length) {
        GLES32.glProgramBinary(program, binaryFormat, binary, length);
    }
    ...
    public void glInvalidateFramebuffer(int target, int numAttachments, int[] attachments, int offset) {
        GLES32.glInvalidateFramebuffer(target, numAttachments, attachments, offset);
    }

    @Override
    public void glInvalidateFramebuffer(int target, int numAttachments, IntBuffer attachments) {
        GLES32.glInvalidateFramebuffer(target, numAttachments, attachments);
    }
    ...
    public void glInvalidateSubFramebuffer(int target, int numAttachments, int[] attachments, int offset, int x, int y, int width, int height) {
        GLES32.glInvalidateSubFramebuffer(target, numAttachments, attachments, offset, x, y, width, height);
    }
    ...
    public void glInvalidateSubFramebuffer(int target, int numAttachments, IntBuffer attachments, int x, int y, int width, int height) {
        GLES32.glInvalidateSubFramebuffer(target, numAttachments, attachments, x, y, width, height);
    }
    ...
    public void glGetInternalformativ(int target, int internalformat, int pname, int bufSize, int[] params, int offset) {
        GLES32.glGetInternalformativ(target, internalformat, pname, bufSize, params, offset);
    }

    @Override
    public void glGetInternalformativ(int target, int internalformat, int pname, int bufSize, IntBuffer params) {
        GLES32.glGetInternalformativ(target, internalformat, pname, bufSize, params);
    }
    ...
    public void glGetFramebufferParameteriv(int target, int pname, int[] params, int offset) {
        GLES32.glGetFramebufferParameteriv(target, pname, params, offset);
    }
    ...
    public void glGetProgramInterfaceiv(int program, int programInterface, int pname, int[] params, int offset) {
        GLES32.glGetProgramInterfaceiv(program, programInterface, pname, params, offset);
    }
    ...
    public void glGetProgramResourceiv(int program, int programInterface, int index, int propCount, int[] props, int propsOffset, int bufSize, int[] length, int lengthOffset, int[] params, int paramsOffset) {
        GLES32.glGetProgramResourceiv(program, programInterface, index, propCount, props, propsOffset, bufSize, length, lengthOffset, params, paramsOffset);
    }
    ...
    public void glGetProgramResourceiv(int program, int programInterface, int index, int propCount, IntBuffer props, int bufSize, IntBuffer length, IntBuffer params) {
        GLES32.glGetProgramResourceiv(program, programInterface, index, propCount, props, bufSize, length, params);
    }
    ...
    public void glGetProgramPipelineiv(int pipeline, int pname, int[] params, int offset) {
        GLES32.glGetProgramPipelineiv(pipeline, pname, params, offset);
    }
    ...
    public void glGetBooleani_v(int target, int index, boolean[] data, int offset) {
        GLES32.glGetBooleani_v(target, index, data, offset);
    }
    ...
    public void glGetMultisamplefv(int pname, int index, float[] val, int offset) {
        GLES32.glGetMultisamplefv(pname, index, val, offset);
    }
    ...
    public void glGetTexLevelParameteriv(int target, int level, int pname, int[] params, int offset) {
        GLES32.glGetTexLevelParameteriv(target, level, pname, params, offset);
    }
    ...
    public void glGetTexLevelParameterfv(int target, int level, int pname, float[] params, int offset) {
        GLES32.glGetTexLevelParameterfv(target, level, pname, params, offset);
    }
