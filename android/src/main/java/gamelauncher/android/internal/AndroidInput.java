...
package gamelauncher.android.internal;
...
import gamelauncher.android.internal.util.keybind.AbstractKeybindEvent;
import gamelauncher.android.internal.util.keybind.AndroidKeybindManager;
import gamelauncher.android.internal.util.keybind.AndroidKeyboardKeybindEvent;
import gamelauncher.android.internal.util.keybind.AndroidMouse;
...
//                    System.out.println(id + "   " + e);
    ...
    @SuppressWarnings("deprecation") @Override public boolean onKey(View v, int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_DEL) unicode = '\b';
        if (keyCode == KeyEvent.KEYCODE_FORWARD_DEL) unicode = 0x7F;
        Keybind keybind = event.getScanCode() == 0 ? null : keybindManager.keybind(event.getScanCode() | AndroidKeybindManager.BITS_KEY);
        if (keybind == null) return true;
