...
public class AndroidFrame extends AbstractGameResource implements Frame {
    ...
    public AndroidFrame(AndroidGameLauncher launcher) {
        ...
        this.context = new AndroidGLContext(new CopyOnWriteArraySet<>(), launcher, this, null, null, null, launcher.serviceProvider().service(AndroidGLLoader.ANDROID_GL_LOADER).gles());
