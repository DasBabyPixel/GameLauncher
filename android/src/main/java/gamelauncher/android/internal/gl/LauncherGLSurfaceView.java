...
import gamelauncher.android.internal.AndroidInput;
...
public class LauncherGLSurfaceView extends GLSurfaceView {
    ...
    @Deprecated public LauncherGLSurfaceView(Context context) {
        super(context);
        launcher = null;
    }

    @Deprecated public LauncherGLSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
        launcher = null;
    }
    ...
    public LauncherGLSurfaceView(AndroidGameLauncher launcher, Context context) {
        ...
        AndroidGLLoader loader = launcher.serviceProvider().service(AndroidGLLoader.ANDROID_GL_LOADER);
        ...
        setEGLContextFactory(new EGLContextFactory() {
            ...
            @Override public EGLContext createContext(EGL10 egl, EGLDisplay display, EGLConfig eglConfig) {
                launcher.serviceProvider().register(AndroidGameLauncher.EGL10, egl);
                ...
                int[] attrib_list = {EGL_CONTEXT_CLIENT_VERSION, loader.hasGLES30() ? 3 : 2, EGL10.EGL_NONE};
...
//        setEGLConfigChooser(8, 8, 8, 8, 24, 0);
        ...
        setRenderer(glRenderer = new GLRenderer(launcher));
        updateRenderMode();
        setFocusable(true);
