...
class StyleBuilderImpl implements Style.Builder {
	...
	@Override
	public Style.Builder decoration(TextDecoration decoration) {
		return decoration(decoration, decoration.activeState());
	}

	@Override
	public Style.Builder decoration(TextDecoration... decorations) {
	...
	@Override
	public Style.Builder font(@NotNull Key font) {
		this.font = font;
		return this;
	}

	@Override
	public Style.Builder color(TextColor color) {
		this.color = color;
		return this;
	}
