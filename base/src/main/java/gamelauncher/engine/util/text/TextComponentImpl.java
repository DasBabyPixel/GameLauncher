...
class TextComponentImpl extends AbstractComponent implements TextComponent {
	...
	private static TextComponentImpl create(Collection<Component> children, Style style,
			String content) {
	...
	@Override
	public @NotNull Component style(Style style) {
		return null;
	}

	@Override
	public @NotNull Component append(Component other) {
		return null;
	}
	...
	static class Builder extends AbstractComponentBuilder<TextComponent, TextComponent.Builder>
