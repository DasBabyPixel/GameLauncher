...
public class EmbedPath implements java.nio.file.Path {
    ...
    @Override
    public WatchKey register(@NotNull WatchService watcher, Kind<?> @NotNull [] events, Modifier... modifiers) throws IOException {
        if (modifiers != null) {
            throw new UnsupportedOperationException();
        }
    ...
    @Override
    public WatchKey register(@NotNull WatchService watcher, Kind<?> @NotNull ... events) throws IOException {
