...
public class LWJGLGameLauncher extends GameLauncher {
    ...
    public LWJGLGameLauncher() {
        ...
        try {
            ...
            serviceProvider().register(ServiceReference.EXECUTOR_THREAD_HELPER, new LWJGLExecutorThreadHelper());
            serviceProvider().register(ServiceReference.KEYBIND_MANAGER, keybindManager = new LWJGLKeybindManager(this));
            serviceProvider().register(ServiceReference.IMAGE_DECODER, imageDecoder = new AWTImageDecoder());
            ...
            serviceProvider().register(ServiceReference.GUI_MANAGER, guiManager = new LWJGLGuiManager(this));
