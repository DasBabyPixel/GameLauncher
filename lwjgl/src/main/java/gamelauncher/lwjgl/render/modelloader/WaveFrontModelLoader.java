...
public class WaveFrontModelLoader implements ModelSubLoader {
					...
					for (String mtlline : mtlcontent.split("\\R")) {
						...
						if (mtll[0].equals("Ns")) {
							...
							material.ambientColor.color =
									new Vector4f(parseFloat(mtll[1]), parseFloat(mtll[2]),
	...
	private static class IndexGroup {
		...
		public boolean equals(Object obj) {
			...
			return idxNormal == other.idxNormal && idxTexCoord == other.idxTexCoord
					&& idxVertex == other.idxVertex;
		}

		@Override
		public String toString() {
			return "IndexGroup [idxVertex=" + idxVertex + ", idxTexCoord=" + idxTexCoord
					+ ", idxNormal=" + idxNormal + ", index=" + index + "]";
		}
	}
}
