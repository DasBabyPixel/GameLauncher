...
public class GLESDrawContext extends AbstractGameResource implements DrawContext {
    ...
    public GLESDrawContext(Framebuffer framebuffer) {
        this(null, framebuffer, 0, 0, 0, 1, 1, 1);
    }

    private GLESDrawContext(GLESDrawContext parent, Framebuffer framebuffer, double tx, double ty,
    ...
    public GLESDrawContext withProjection(Transformations.Projection projection) {
        GLESDrawContext ctx =
                new GLESDrawContext(this, this.framebuffer, this.tx, this.ty, this.tz, this.sx,
    ...
    public GLESDrawContext withProgram(ShaderProgram program) {
        return new GLESDrawContext(this, this.framebuffer, this.tx, this.ty, this.tz, this.sx,
    ...
    public GLESDrawContext translate(double x, double y, double z) {
        return new GLESDrawContext(this, this.framebuffer, this.tx + x, this.ty + y, this.tz + z,
    ...
    public GLESDrawContext scale(double x, double y, double z) {
        return new GLESDrawContext(this, this.framebuffer, this.tx, this.ty, this.tz, this.sx * x,
