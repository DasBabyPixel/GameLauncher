...
public class WaveFrontModelLoader implements ModelSubLoader {
    ...
    @Override public byte[] convertModel(ResourceStream in) throws GameException {
                ...
                case "mtllib":
                    ...
                    for (String mtlline : mtlcontent.split("\\R")) {
                        ...
                        if (mtll[0].equals("Ns")) {
                            ...
                            material.ambientColor.color = new Vector4f(parseFloat(mtll[1]), parseFloat(mtll[2]), parseFloat(mtll[3]), 1F);
                        } else if (mtll[0].equals("Kd")) {
                            material.diffuseColor.color = new Vector4f(parseFloat(mtll[1]), parseFloat(mtll[2]), parseFloat(mtll[3]), 1F);
                        } else if (mtll[0].equals("Ks")) {
                            material.specularColor.color = new Vector4f(parseFloat(mtll[1]), parseFloat(mtll[2]), parseFloat(mtll[3]), 1F);
    ...
    private static class IndexGroup {
        ...
        @Override public String toString() {
            return "IndexGroup [idxVertex=" + idxVertex + ", idxTexCoord=" + idxTexCoord + ", idxNormal=" + idxNormal + ", index=" + index + "]";
        }
    }
}
