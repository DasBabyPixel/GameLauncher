...
public interface GLES20 {
     ...
     * Broken
     */
    void glGetActiveAttrib(int program, int index, int bufsize, java.nio.IntBuffer length, java.nio.IntBuffer size, java.nio.IntBuffer type, byte name);
     ...
     * Broken
     */
    void glGetActiveUniform(int program, int index, int bufsize, java.nio.IntBuffer length, java.nio.IntBuffer size, java.nio.IntBuffer type, byte name);
     ...
     * broken
     */
    void glGetShaderSource(int shader, int bufsize, java.nio.IntBuffer length, byte source);
